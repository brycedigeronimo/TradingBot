/* ============================================================
 * Taken from official Binance Node Documentation. Only modifications were changing Binance to Binance.us
 * node-binance-api
...
let api = function Binance( options = {} ) {
  ...
  let fstream = 'wss://fstream.binance.us.com/stream?streams=';
  let fstreamSingle = 'wss://fstream.binance.us.com/ws/';
  let fstreamSingleTest = 'wss://stream.binancefuture.com/ws/';
  let fstreamTest = 'wss://stream.binancefuture.com/stream?streams=';
  let dstream = 'wss://dstream.binance.us.com/stream?streams=';
  let dstreamSingle = 'wss://dstream.binance.us.com/ws/';
  let dstreamSingleTest = 'wss://dstream.binancefuture.com/ws/';
  let dstreamTest = 'wss://dstream.binancefuture.com/stream?streams=';
  let stream = 'wss://stream.binance.us.com:9443/ws/';
  let combineStream = 'wss://stream.binance.us.com:9443/stream?streams=';
 ...
 */
  ...
  return {
      ...
      */
      ...
      New Future Account Transfer POST https://api.binance.us/sapi/v1/futures/transfer
      Get Postion Margin Change History (TRADE)

      wss://fstream.binance.us.com/ws/<listenKey>
